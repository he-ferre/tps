...
public class TexTok {
    ...
    private void crearTexto(NodoArbolUsuarios usuario) {
        ...
        if (!textoRep) {
            ...
            insertarTexto(nuevo,  usuario.getTextosCreados());
    ...
    public void insertarTexto(NodoTexto nuevo, NodoTexto primeroCreados) {
        if (primeroCreados == null) {
            // Si la lista está vacía, el nuevo pasa a ser el primero
            primeroCreados = nuevo;
        } else {
            insertarRecursivo(primeroCreados, nuevo);
        }
    }
    ...
    private  void visualizarTexto(NodoArbolUsuarios usuario) {
        ...
        if (texto != null) {
            ...
            System.out.println("Vistas actuales: " + texto.getVistas());
            ...
            System.out.println("Total de vistas: " + texto.getVistas());
        } else {
            System.out.println("No hay textos para visualizar.");
        }
    }

    // public void insertarTextoVisto(NodoTexto texto, NodoArbolUsuarios usuarios) {
    //     NodoVisto nuevo = new NodoVisto(texto);
    
    //     if (usuarios.getTextosVisto() != null) {
    //         insertarTextoVistoRec(primeroVistos.getSiguiente(), nuevo);
    //     } else {
    //         texprimeroVistos = nuevo;
    //     }
    // }
    // private void insertarTextoVistoRec(NodoVisto actual, NodoVisto nuevo) {
    //     if (actual.getSiguiente() != null) {
    //         insertarTextoVistoRec(actual.getSiguiente(), nuevo);
    //     } else {
    //         actual.setSiguiente(nuevo);
    //     }
    // }
