...
public class Main{
    ...
    public static void main(String[] args) {
        TexTok.cargarArbolDesdeArchivo();
        TexTok.cargarTextosDesdeArchivos();
        TexTok.cargarVistasDesdeArchivos();
        menuUno();
    }
    ...
    public static void menuUno(){
        ...
        do{
            ...
            switch (seleccion) {
                ...
                case 6 :  // salir
                    //guardar datos\
                    TexTok.generarInfoUsuarios();
                    TexTok.generarInfoTextos();
                    TexTok.guardarVistas();
                    //TexTok.obtenerDatos();
                    break;
                default:
